...
class createRequest():
	...
	self.user_follower_map = {}
        self.start_page = 1
        self.parser = processUserData("/home/garima/IR/gitbook/data1")
    ...
    def curl_cmd(self, url, header_params = None, post_params=None):     
        while True:
            ...
            if http_code == 500 or http_code == 501 or http_code == 502 or http_code == 503 or http_code == 504 or http_code == 403:
                time.sleep(600)
            else:
                break
    ...
    def get_top_users_with_followers(self, number_users, follower_count_cap):
	    ...
	    self.get_followers(users)
            ...
            if count >= 1000:
                ...
                self.start_page = 1
	    self.parser.dump_data(self.user_follower_map, "user_followers_map")

if __name__ == '__main__':
    obj = createRequest()
    obj.get_auth_token()
    obj.get_top_users_with_followers(10000, 20000)
